  ...
  <form method="post" id="user_form" enctype="multipart/form-data">
   <div class="modal-content">
    ...
    <div class="modal-body">
     ...
     <br />
     <br />
     <label>Enter Product Ram</label>
     <input type="text" name="product_ram" id="product_ram" class="form-control" />
     <br />
     <br />
     <label>Enter Product Storage</label>
     <input type="text" name="product_storage" id="product_storage" class="form-control" />
     <br />
     <br />
     <label>Enter Product Camera</label>
     <input type="text" name="product_camera" id="product_camera" class="form-control" />
     <br />
     <br />
...
$(document).ready(function(){
 ...
 $(document).on('submit', '#user_form', function(event){
  ...
  var productRam = $('#product_ram').val();
  var productStorage = $('#product_storage').val();
  var productCamera = $('#product_camera').val();
  var productQuantity = $('#product_quantity').val();
  var productStatus = $('#product_status').val();
   ...
   success:function(data)
   {
    ...
    $('#product_brand').val(data.product_brand);
     $('#product_price').val(data.product_price);
      $('#product_ram').val(data.product_ram);
       $('#product_storage').val(data.product_storage);
        $('#product_camera').val(data.product_camera);
