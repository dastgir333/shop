...
if(isset($_POST['form_login'])){
	...
	try{
		...
		$statement = $db->prepare("select * from myusers where user_name=?");
		...
		$statement = $db->prepare("insert into myusers (name, user_name, user_pass, user_email, user_phone) values(?,?,?,?,?)");
			...
			<div class="col-md-8 col-md-offset-2">
				...
				<div class="login_block_bg">					
					...
					<form action="" method="post">
						...
						<a href="login2.php">Back to login Page</a>
					</form>
					<div >&nbsp;</div>
					<div >&nbsp;</div>
				</div>
